...
<h4>2.   KHI NÀO Amazing SẼ THU THẬP DỮ LIỆU CÁ NHÂN?</h4>
...
i.    khi bạn gửi dữ liệu cá nhân của bạn cho chúng tôi vì bất kỳ lý do gì.
...
<h4>3.   Amazing SẼ THU THẬP NHỮNG DỮ LIỆU GÌ?</h4>

3.1.         Dữ liệu cá nhân mà Amazing có thể thu thập bao gồm, nhưng không giới hạn:
...
<h4>4.   THU THẬP CÁC DỮ LIỆU KHÁC</h4>
...
5.2.         Bạn có thể từ chối sử dụng cookie bằng cách chọn các thiết lập thích hợp trên trình duyệt của bạn. Tuy nhiên, vui lòng lưu ý rằng nếu bạn thực hiện thao tác này bạn có thể không sử dụng được các chức năng đầy đủ của Nền tảng hoặc Các Dịch Vụ của chúng tôi.

<h4>6.   XEM VÀ TẢI CÁC NỘI DUNG VÀ QUẢNG CÁO</h4>

6.1.         Do khi bạn xem các trang trên trang web hoặc ứng dụng di động của chúng tôi, khi bạn xem các nội dung và quảng cáo và truy cập vào các phần mềm khác trên Nền tảng của chúng tôi hoặc thông qua Dịch vụ, phần lớn các thông tin giống nhau sẽ được gửi đến cho chúng tôi (bao gồm, nhưng không giới hạn, địa chỉ IP, hệ điều hành, v.v…); nhưng, thay vì các lượt xem trang, thiết bị của bạn gửi đến chúng tôi thông tin về các nội dung, quảng cáo được xem và/hoặc phần mềm được cài đặt trên các Dịch vụ và Nền tảng và thời gian.

<h4>7.   CHÚNG TÔI SỬ DỤNG THÔNG TIN BẠN CUNG CẤP CHO CHÚNG TÔI NHƯ THẾ NÀO?</h4>

7.1.         Chúng tôi có thể thu thập, sử dụng, tiết lộ và/hoặc xử lý dữ liệu cá nhân của bạn vì một hoặc nhiều mục đích sau đây:
...
q.   để kiểm tra Các Dịch Vụ của chúng tôi hoặc hoạt động của Amazing;
...
c.   người mua hoặc người thừa nhiệm khác trong trường hợp sáp nhập, thoái vốn, tái cơ cấu, tái tổ chức, giải thể hoặc bán hay chuyển nhượng một phần hoặc tất cả tài sản của Amazing, cho dù là vấn đề đang diễn ra hay đang trong thủ tục phá sản, thanh lý hoặc thủ tục tương tự, trong đó dữ liệu cá nhân Amazing lưu giữ về người dùng của chúng tôi nằm trong các tài sản được chuyển nhượng; hoặc cho một bên đối tác trong một giao dịch tài sản kinh doanh mà Amazing hoặc bất kỳ công ty liên kết hay công ty liên quan nào của nó có tham gia giao dịch; và
...
<h4>13. BẠN CÓ THỂ RÚT TÊN, XÓA TÊN, YÊU CẦU TRUY CẬP HOẶC ĐIỀU CHỈNH THÔNG TIN BẠN ĐÃ CUNG CẤP CHO CHÚNG TÔI BẰNG CÁCH NÀO?</h4>

Rút Lại Sự Đồng Ý

13.1.       Bạn có thể rút lại sự đồng ý cho phép thu thập, sử dụng và/hoặc tiết lộ dữ liệu cá nhân của bạn mà chúng tôi đang lưu giữ hoặc kiểm soát bằng cách gửi email cho Bộ phận Bảo Vệ Dữ Liệu Cá Nhân của chúng tôi tại địa chỉ email lethanhhiep@lethanhhiep.ml hoặc qua ĐÂY, và chúng tôi sẽ xử lý các yêu cầu này theo Chính Sách Bảo Mật cũng như quy định pháp luật có liên quan.

13.2.       Tuy nhiên, việc bạn rút lại sự đồng ý có thể có nghĩa là chúng tôi sẽ không thể tiếp tục cung cấp Các Dịch Vụ cho bạn, và chúng tôi có thể cần phải chấm dứt quan hệ hiện tại của bạn và/hoặc hợp đồng của bạn với chúng tôi.

13.3     Khi bạn chia sẻ Nội Dung YouTube, bên cạnh việc rút lại sự đồng ý bằng cách gửi email cho chúng tôi theo Khoản 13.1, bạn có thể hủy cho phép truy cập của Amazing đến các thông tin cá nhân của bạn thông qua tùy chọn bảo mật của Google tại https://security.google.com/settings/security/permissions.

Yêu Cầu Truy Cập đến hoặc Sửa Dữ Liệu Cá Nhân

13.4.       Nếu bạn đã đăng ký một tài khoản với chúng tôi, cá nhân bạn có thể truy cập và/hoặc sửa dữ liệu cá nhân của bạn mà chúng tôi đang lưu giữ hoặc kiểm soát thông qua trang Thiết Lập Tài Khoản hoặc nhãn trên Nền tảng. Nếu bạn chưa đăng ký tài khoản với chúng tôi, cá nhân bạn có thể yêu cầu truy cập và/hoặc sửa dữ liệu cá nhân của bạn mà chúng tôi đang lưu giữ hoặc kiểm soát bằng cách gửi yêu cầu bằng văn bản cho chúng tôi. Chúng tôi sẽ cần có đủ thông tin từ bạn để xác định danh tính của bạn cũng như bản chất yêu cầu của bạn để có thể giải quyết yêu cầu của bạn. Do đó, vui lòng gửi yêu cầu bằng văn bản của bạn bằng cách gửi email cho nhân viên Quản lý dữ liệu của chúng tôi tại ĐÂY.

13.5.       Chúng tôi có thể tính một khoản phí hợp lý cho bạn để giải quyết và xử lý yêu cầu truy cập dữ liệu cá nhân của bạn. Nếu chúng tôi có tính phí, chúng tôi sẽ cung cấp cho bạn ước tính lệ phí bằng văn bản. Vui lòng lưu ý rằng chúng tôi không buộc phải đáp ứng hay giải quyết yêu cầu truy cập của bạn trừ phi bạn đã đồng ý đóng phí.

13.6.       Chúng tôi bảo lưu quyền từ chối sửa dữ liệu cá nhân của bạn theo các quy định của pháp luật về bảo vệ bí mật thông tin cá nhân, trường hợp các điều luật đó yêu cầu và/hoặc cho phép một tổ chức từ chối sửa dữ liệu cá nhân trong các trường hợp như thế.

<h4>14. THẮC MẮC, QUAN NGẠI HOẶC KHIẾU NẠI? LIÊN HỆ VỚI CHÚNG TÔI</h4>
